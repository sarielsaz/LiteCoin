Sarielsaz version 0.5.4 is now available for download at:
http://sourceforge.net/projects/sarielsaz/files/Sarielsaz/sarielsaz-0.5.4/
...
http://gitorious.org/sarielsaz/sarielsazd-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Sarielsaz-Qt notifications under Growl 1.3.
Increase required age of Sarielsaz-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxSarielsaz properly when installing Sarielsaz-Qt over it. (Windows)
