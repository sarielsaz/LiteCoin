Sarielsaz Core version 0.13.2 is now available from:

  <https://sarielsaz.org/bin/sarielsaz-core-0.13.2/>
...
- #8908 `4a974b2` Update sarielsaz-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow sarielsaz-tx to create v2 transactions (btcdrak)
