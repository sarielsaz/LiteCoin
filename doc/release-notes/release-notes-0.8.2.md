...
* Entering the 'getblocktemplate' or 'getwork' RPC commands into the Sarielsaz-Qt debug
console will cause Sarielsaz-Qt to crash. Run Sarielsaz-Qt with the -server command-line
