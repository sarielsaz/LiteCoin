Sarielsaz Core version 0.10.4 is now available from:

  <https://sarielsaz.org/bin/sarielsaz-core-0.10.4/>
...
- #6953 `43c2789` Split sarielsaz-tx into its own package
- #6953 `dfe0d4d` Include sarielsaz-tx binary on Debian/Ubuntu
