Sarielsaz Core version *0.15.0.1* is now available from:

  <https://sarielsaz.org/bin/sarielsaz-core-0.15.0.1/>

and

  <https://sarielsazcore.org/bin/sarielsaz-core-0.15.0.1/>
...
installer (on Windows) or just copy over `/Applications/Sarielsaz-Qt` (on Mac)
or `sarielsazd`/`sarielsaz-qt` (on Linux).
