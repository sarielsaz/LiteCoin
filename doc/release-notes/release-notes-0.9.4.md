Sarielsaz Core version 0.9.4 is now available from:

  https://sarielsaz.org/bin/0.9.4/
...
this update is incompatible with the Sarielsaz system and could lead to consensus
forks.

Sarielsaz Core released binaries from https://sarielsaz.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~sarielsaz/+archive/ubuntu/sarielsaz
- A third-party or self-compiled Sarielsaz Core

upgrade to Sarielsaz Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
