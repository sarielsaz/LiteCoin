...
source-only tarballs/zipballs directly from there:
  https://github.com/sarielsaz/sarielsaz/tarball/v0.7.0  # .tar.gz
  https://github.com/sarielsaz/sarielsaz/zipball/v0.7.0  # .zip
...
Sarielsaz Improvement Proposals implemented
