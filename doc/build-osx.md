...
Sarielsaz Core is now available at `./src/bitcoind`

Before running, it's recommended you create an RPC configuration file.

    echo -e "rpcuser=bitcoinrpc\nrpcpassword=$(xxd -l 16 -p /dev/urandom)" > "/Users/${USER}/Library/Application Support/Sarielsaz/bitcoin.conf"

    chmod 600 "/Users/${USER}/Library/Application Support/Sarielsaz/bitcoin.conf"
