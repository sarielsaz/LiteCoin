...
This document provides guidelines for internationalization of the Sarielsaz Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `sarielsaz_en.ts` remains unchanged.
