...
class BIP66Test(SarielsazTestFramework):
    ...
    def run_test(self):
        ...
        with mininode_lock:
            ...
            # sarielsazd is running with multiple script check threads. If script
            # check threads are not in use, then transaction script validation
            # happens sequentially, and sarielsazd produces more specific reject
            # reasons.
