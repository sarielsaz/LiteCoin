...
Also test that nodes that send unsupported service bits to sarielsazd are disconnected
...
class CNodeNoVersionBan(CLazyNode):
    ...
    # NOTE: implementation-specific check here. Remove if sarielsazd ban behavior changes
    def on_open(self, conn):
        super().on_open(conn)
