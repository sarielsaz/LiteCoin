...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the SarielsazTestFramework
    pass

class ExampleTest(SarielsazTestFramework):
    # Each functional test is a subclass of the SarielsazTestFramework class.
    ...
    def custom_method(self):
        ...
        SarielsazTestFramework class so other tests can use it."""
