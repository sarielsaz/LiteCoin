...
# TestNode: A peer we use to send messages to sarielsazd, and store responses.
...
class CompactBlocksTest(SarielsazTestFramework):
    ...
    # This test actually causes sarielsazd to (reasonably!) disconnect us, so do this last.
    ...
    # Test that sarielsazd requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for sarielsazd to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # sarielsazd will not send blocktxn responses for blocks whose height is
