...
#ifndef SARIELSAZ_TEST_SCRIPTNUM10_H
#define SARIELSAZ_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Sarielsaz Core 0.10.0, for cross-comparison.
 */
public:
