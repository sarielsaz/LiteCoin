...
#include "qt/sarielsazamountfield.h"
...
uint256 SendCoins(CWallet& wallet, SendCoinsDialog& sendCoinsDialog, const CTxDestination& address, CAmount amount, bool rbf)
{
    ...
    entry->findChild<SarielsazAmountField*>("payAmount")->setValue(amount);
...
//
//     src/qt/test/test_sarielsaz-qt -platform xcb      # Linux
//     src/qt/test/test_sarielsaz-qt -platform windows  # Windows
//     src/qt/test/test_sarielsaz-qt -platform cocoa    # macOS
void TestGUI()
{
    ...
    QString balanceComparison = SarielsazUnits::formatWithUnit(unit, balance, false, SarielsazUnits::separatorAlways);
    ...
    // Amount input
    SarielsazAmountField* amountInput = receiveCoinsDialog.findChild<SarielsazAmountField*>("reqAmount");
    ...
    for (QWidget* widget : QApplication::topLevelWidgets()) {
        if (widget->inherits("ReceiveRequestDialog")) {
            ...
            QVERIFY(paymentTextList.at(1).indexOf(QString("URI: sarielsaz:")) != -1);
