...
/** Sarielsaz unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class SarielsazUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit SarielsazUnits(QObject *parent);

    /** Sarielsaz units.
      @note Source: https://en.sarielsaz.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        BTC,
