...
const char * const SARIELSAZ_CONF_FILENAME = "sarielsaz.conf";
const char * const SARIELSAZ_PID_FILENAME = "sarielsazd.pid";
...
fs::path GetPidFile()
{
    fs::path pathPidFile(gArgs.GetArg("-pid", SARIELSAZ_PID_FILENAME));
...
std::string CopyrightHolders(const std::string& strPrefix)
{
    ...
    // Check for untranslated substitution to make sure Sarielsaz Core copyright is not removed by accident
    if (strprintf(COPYRIGHT_HOLDERS, COPYRIGHT_HOLDERS_SUBSTITUTION).find("Sarielsaz Core") == std::string::npos) {
        strCopyrightHolders += "\n" + strPrefix + "The Sarielsaz Core developers";
    }
