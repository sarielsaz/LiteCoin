...
#ifndef SARIELSAZ_WALLET_WALLET_H
#define SARIELSAZ_WALLET_WALLET_H
...
public:
     ...
     * on this sarielsaz node, and set to 0 for transactions that were created
...
#endif // SARIELSAZ_WALLET_WALLET_H
