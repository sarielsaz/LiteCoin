 ...
 * between sarielsazd, and sarielsaz-qt and non-server tools.
*/
...
void Shutdown()
{
    ...
    RenameThread("sarielsaz-shutoff");
...
#ifndef WIN32
    strUsage += HelpMessageOpt("-pid=<file>", strprintf(_("Specify pid file (default: %s)"), SARIELSAZ_PID_FILENAME));
#endif
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/sarielsaz/sarielsaz>";
    const std::string URL_WEBSITE = "<https://sarielsazcore.org>";
...
void ThreadImport(std::vector<fs::path> vImportFiles)
{
    ...
    RenameThread("sarielsaz-loadblk");
...
/** Sanity checks
 *  Ensure that Sarielsaz is running in a usable environment with all
...
static bool LockDataDirectory(bool probeOnly)
{
    ...
    // Make sure only a single Sarielsaz process is using the data directory.
...
bool AppInitMain(boost::thread_group& threadGroup, CScheduler& scheduler)
{
    ...
    LogPrintf("Using config file %s\n", GetConfigFile(gArgs.GetArg("-conf", SARIELSAZ_CONF_FILENAME)).string());
